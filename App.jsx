...
const TERMS_TEXT = `軽貨物求人.com 利用規約

制定日：2026年　月　日
最終改定日：2026年　月　日

軽貨物求人.com（以下「当サイト」といいます。）は、求人情報の掲載および閲覧等のサービスを提供しています。本規約は、当サイトが提供するサービス（以下「本サービス」といいます。）の利用条件を定めるものです。

第1条（目的）

本規約は、本サービスを利用するすべての利用者と当サイトとの間の権利義務関係および本サービスの利用条件を定めることを目的とします。

第2条（本サービスの性質および基本方針）

1. 情報提供プラットフォーム
当サイトは、求人事業者（以下「掲載事業者」といいます。）が提供する軽貨物運送等に関する求人情報を掲載し、求職者がこれを閲覧するための情報提供プラットフォームです。

2. 職業紹介等を行わないこと
当サイトは、求職者と掲載事業者との間における職業紹介、労働者派遣、労働者供給、採用の斡旋、採用仲介その他これらに類する行為を行いません。

3. 直接の問い合わせ・応募
求職者は、掲載された求人情報を確認した上で、掲載事業者に対して直接問い合わせ、応募その他必要な連絡を行うものとします。

4. 契約当事者ではないこと
掲載事業者と求職者との間で行われる採用選考、条件交渉、契約締結その他のやり取りについて、当サイトは当事者、代理人または仲介者となりません。

5. 自己責任による利用
求職者および掲載事業者は、掲載情報および相手方とのやり取りについて、自ら確認・判断した上で本サービスを利用するものとします。

第3条（個人情報・事業者情報の最小限収集・保持）

1. 最小限保持の原則
当サイトは、法令上、セキュリティ上、決済上または本サービスの運営上必要となる情報を除き、求職者および掲載事業者に関する情報を必要以上に取得、保存または蓄積しないよう努めます。

2. 求職者情報
当サイトは、原則として求職者の会員登録または求職者データベースを設けません。また、履歴書、職務経歴書、身分証明書、銀行口座情報、クレジットカード情報その他の求職者の重要な個人情報を、本サービスの提供に必要な範囲を超えて取得・保存しません。

3. 掲載事業者情報
当サイトは、求人掲載、掲載審査、決済、不正利用防止、サービス運営その他必要な目的の範囲を超えて、掲載事業者または担当者の情報を取得・保存しません。

4. 掲載終了後の情報
掲載終了後の求人情報その他の関連データについては、法令上の保管義務、紛争への対応、不正利用防止、セキュリティその他正当な必要性が存続する場合を除き、必要性がなくなった後、合理的な期間内に削除または匿名化等の処理を行います。

5. ログ等の技術情報
IPアドレス、アクセスログ、端末情報その他の技術情報については、不正アクセス防止、サービスの安全な運営、障害対応、犯罪防止または法令対応等のために必要な範囲および期間で取り扱います。

6. 詳細な取扱い
個人情報その他の情報の具体的な取得項目、利用目的、第三者提供、保存期間その他の取扱いについては、当サイトが別途定めるプライバシーポリシーによるものとします。

第4条（求人情報の掲載責任および透明性）

1. 掲載事業者の責任
掲載事業者は、自らの責任において求人情報を作成・掲載するものとし、掲載内容について真実性、正確性、最新性および適法性を確保する責任を負います。

2. 重要条件の明示
掲載事業者は、求職者が応募または契約を判断するために重要となる条件について、具体的かつ分かりやすく記載しなければなりません。特に、以下の事項を可能な限り明確に表示するものとします。
・業務内容および具体的な配送物
・主な配送エリア、稼働地域
・報酬形態（個口単価、日給、月給等）
・報酬の支払時期・支払条件
・契約形態（業務委託、雇用等）
・ロイヤリティその他の控除・負担金
・車両リース費、レンタル費その他車両関連費用
・加盟金、登録料、研修費その他の初期費用
・違約金、罰金その他の求職者が負担する可能性のある費用
・保険料その他業務上必要となる費用
・その他、応募または契約の判断に重要な条件

3. 不明瞭な掲載の禁止
掲載事業者は、重要な契約条件等について、「詳細は面接時に説明する」「応募後に説明する」「個別に説明する」等の記載だけで済ませ、当サイト上で重要条件を確認できない状態にしてはなりません。

4. 外部サイト・SNSへの誘導
求人情報の詳細を不明瞭にする目的で、SNS、メッセージアプリその他の外部サービスへの移動を求める行為を禁止します。ただし、通常の企業連絡先、公式ウェブサイトその他、正当な採用活動に必要な情報の掲載まで一律に禁止するものではありません。

5. 情報変更時の更新義務
掲載事業者は、掲載内容に変更が生じた場合、速やかに求人情報を更新し、常に最新の情報を表示するよう努めなければなりません。

6. 確認・修正への協力
当サイトから求人情報の確認、根拠資料の提示、修正、更新その他必要な対応を求められた場合、掲載事業者は合理的な範囲でこれに協力するものとします。

第5条（掲載禁止求人）

掲載事業者は、以下に該当する求人情報を掲載してはなりません。

1. 闇バイト、特殊詐欺、強盗、受け子・出し子、違法薬物の運搬その他の犯罪行為または違法行為に関連する求人

2. 匿名・流動型犯罪グループ（いわゆる「トクリュウ」）その他の犯罪組織、反社会的勢力等に関連する求人

3. 求職者から身分証明書、銀行口座、クレジットカード情報その他の重要な個人情報を、不当または不自然な目的で取得することを目的とする求人

4. 実際の業務内容、報酬、費用負担その他の重要条件と著しく異なる虚偽、誇大または誤解を招く求人

5. 求職者に不合理な費用負担を求めることを主たる目的とする求人

6. その他、法令、公序良俗または本サービスの安全な運営に重大な支障を及ぼすと当サイトが合理的に判断する求人

第6条（求人掲載の審査・管理および対応権限）

1. 掲載審査
当サイトは、提出された求人情報について、入力内容の確認、自動システム、AI等によるリスク分析および必要に応じた目視確認を行うことがあります。

2. AIの位置付け
AI等による自動分析は、求人情報に含まれる不自然な表現、条件、リスクその他の確認事項を抽出するための補助的な手段であり、AIによって犯罪者、犯罪組織または違法行為を確定的に認定するものではありません。

3. 追加確認
当サイトは、求人内容について確認が必要と判断した場合、掲載事業者に対して追加説明、情報修正、資料提出その他必要な対応を求めることがあります。

4. 掲載保留・修正・削除等
当サイトは、以下のいずれかに該当すると合理的に判断した場合、事前の通知なく、求人掲載の保留、修正要求、掲載停止、削除または掲載事業者による本サービスの利用停止等の措置を講じることができます。
・本規約または求人掲載ガイドラインに違反した場合
・求人内容に虚偽、誤解を招く表現または法令違反の疑いがある場合
・詐欺、犯罪への関与その他求職者の安全上の重大な懸念がある場合
・審査を回避する目的で不正な操作を行った場合
・当サイトからの確認・修正依頼に合理的な期間内に対応しない場合
・その他、本サービスの安全または適正な運営のために掲載継続が不適切であると合理的に判断した場合

5. 審査基準の非開示
当サイトは、犯罪防止、不正利用防止、審査システムの安全性その他の理由により、審査基準、検知ロジックその他の詳細を開示しないことがあります。

第7条（有料広告・掲載料金）

1. 料金
有料表示オプションまたは広告枠の料金は、以下のとおりとします。
・地域広告：月額10,000円（税別）
・TOP広告：月額50,000円（税別）

2. 契約単位・決済
有料広告は月額単位とし、当サイトが指定する決済サービス（Stripe等）を利用して決済します。

3. 日割り計算
有料広告料金について、原則として日割りによる減額または返金は行いません。

4. 掲載開始日
有料広告の掲載開始日は、当サイトが別途定める条件によるものとし、原則として月単位で取り扱います。

5. 審査と広告購入の独立性
有料広告の申込み、決済または広告枠の予約は、求人掲載審査の通過または掲載継続を保証するものではありません。

6. 掲載前の不承認
決済後、掲載前の審査により広告掲載を承認しないこととなった場合、未提供期間に対応する料金について、当サイトが定める方法により返金または決済取消等の処理を行います。

7. 違反による停止等
掲載開始後、掲載事業者の規約違反、虚偽掲載、犯罪関与その他掲載事業者側の事由により掲載停止または削除となった場合、既に提供された期間に対応する料金については返金しません。

第8条（掲載事業者と求職者とのトラブル）

1. 掲載事業者と求職者との間で生じる採用の有無、労働条件、業務委託条件、報酬、報酬の未払い、ロイヤリティ、車両費、その他費用、業務内容、交通事故、配送事故、損害賠償、違約金、契約解除その他一切の契約・取引上の問題について、当サイトは当事者となりません。

2. 当サイトは、前項に定める当事者間の契約・取引上の紛争について、原則として交渉、仲裁、損害賠償請求その他の紛争解決に介入しません。

3. 求職者および掲載事業者は、相手方との契約または取引を行う前に、自ら必要な確認を行い、自らの責任において判断するものとします。

4. ただし、掲載情報が法令違反、犯罪行為、詐欺その他本サービスの安全な運営に重大な問題があると認められる場合、当サイトは第6条に基づき必要な対応を行うことがあります。

第9条（情報の正確性等に関する免責）

1. 求人情報は、掲載事業者自身が提供するものです。当サイトは、掲載事業者による情報提供について、一定の確認・是正対応を行いますが、掲載情報の完全な正確性、最新性、合法性、安全性または有用性を保証するものではありません。

2. 当サイトは、掲載事業者と求職者との間で締結される契約の内容、契約の履行、報酬の支払、業務上の事故その他当事者間の契約・取引について保証しません。

3. 当サイトの故意または重大な過失による場合を除き、本サービスの利用に関連して生じた損害について、当サイトは法令上認められる範囲で責任を負わないものとします。

4. 前項にかかわらず、当サイトが責任を負う場合であっても、法令上許される範囲において、当サイトの責任は通常かつ直接に生じた損害を限度とし、特別損害、間接損害、逸失利益等については責任を負わないものとします。

第10条（公的機関等への情報提供）

当サイトは、以下の場合その他法令上認められる場合に、個人情報その他当サイトが保有する情報を、必要な範囲で公的機関その他の第三者に提供することがあります。

1. 法令に基づく照会、捜査その他の要請がある場合
2. 裁判所その他の公的機関による命令等がある場合
3. 人の生命、身体または財産の保護のために必要であり、本人の同意を得ることが困難な場合
4. その他、個人情報保護法その他関係法令により認められる場合

第11条（本サービスの変更・停止等）

1. 当サイトは、システム障害、メンテナンス、通信障害、天災、サイバー攻撃、第三者サービスの障害その他やむを得ない事情により、本サービスの全部または一部を一時的に変更、停止または中断することがあります。

2. 当サイトは、法令上の義務がある場合を除き、サービスの変更、停止または中断によって利用者に生じた損害について、法令上認められる範囲で責任を負わないものとします。

第12条（本規約の変更）

1. 当サイトは、法令の改定、本サービスの内容・構造の変更、セキュリティの強化、運営上の必要性その他合理的な理由がある場合、本規約を変更することがあります。

2. 本規約を変更する場合、当サイトは、変更内容および変更後の効力発生日を、当サイト上への掲示その他適切な方法により周知します。

3. 変更後の規約は、前項に定める効力発生日から適用されるものとします。

4. 効力発生日以降に本サービスを利用した場合、利用者は変更後の規約に同意したものとみなします。
...
3. 虚偽の情報を登録または掲載する行為
4. 他人または他社になりすます行為
5. 審査を回避するために、求人情報を削除・再掲載する等の不正な行為
6. 本サービスのシステムまたはサーバーに過度な負荷を与える行為
7. 本サービスの運営を妨害する行為
8. 他の利用者または第三者に対する不当な嫌がらせ、脅迫、誹謗中傷等
9. その他、当サイトが本サービスの運営上不適切と判断する行為

第14条（反社会的勢力の排除）

1. 利用者は、現在および将来にわたり、暴力団、暴力団員、暴力団関係企業その他これらに準ずる反社会的勢力に該当しないことを表明し、保証するものとします。

2. 利用者が反社会的勢力に該当すると当サイトが合理的に判断した場合、当サイトは事前の通知なく、本サービスの利用停止、求人情報の削除その他必要な措置を講じることができます。

第15条（分離可能性）

本規約のいずれかの条項またはその一部が、法令その他の理由により無効または執行不能と判断された場合であっても、本規約のその他の条項は引き続き有効に存続するものとします。無効または執行不能とされた条項については、その趣旨および法令上許容される範囲において、当初の条項に最も近い内容となるよう合理的に解釈されるものとします。

第16条（協議）

本規約に定めのない事項または本規約の解釈について疑義が生じた場合、当サイトと利用者は、関係法令および本サービスの趣旨に従い、誠実に協議して解決を図るものとします。

第17条（準拠法および管轄裁判所）

1. 本規約の解釈および適用については、日本法を準拠法とします。

2. 本サービスに関して当サイトと利用者との間で紛争が生じた場合、法令に別段の定めがある場合を除き、当サイト運営事業者の所在地を管轄する地方裁判所または簡易裁判所を第一審の合意管轄裁判所とします。


軽貨物求人.com 基本方針

軽貨物求人.comは、求人情報を分かりやすく掲載・提供する情報サイトです。

・職業紹介・採用仲介は行いません。
・求職者と掲載事業者が直接やり取りします。
・応募・契約について当サイトは当事者となりません。
・掲載事業者が求人情報の正確性・最新性を確保する責任を負います。
・重要な報酬・費用・契約条件をできる限り事前に確認できる状態で掲載します。
・闇バイト、詐欺、犯罪行為等につながる求人は掲載しません。
・必要以上の個人情報・事業者情報を取得・保存しない設計・運用を基本とします。
・当事者間の契約・取引トラブルには原則として介入しません。
・一方で、違法求人や危険な求人については、必要に応じて掲載停止・削除等の対応を行います。

本サービスの利用者は、掲載情報および相手方とのやり取りについて、自ら確認し、自らの判断と責任において応募・契約等を行うものとします。`

const PRIVACY_TEXT = `軽貨物求人.com プライバシーポリシー

第1条（基本方針・個人情報の最小限保持）

1. 当サイトは、必要以上の個人情報を収集・保存しない方針とし、本サービスの提供、セキュリティ確保、決済処理および法令遵守に必要な範囲で情報を取り扱います。

2. 当サイトは、原則として求職者の会員登録機能や求職者データベースを設けません。求職者が掲載事業者へ連絡・応募する場合は、掲載事業者が指定する連絡先へ直接連絡する仕組みです。当サイトは、求職者の履歴書、職務経歴書、身分証明書、口座情報等を応募受付のために取得・恒久保存しません。ただし、サイト閲覧時の技術情報や問い合わせ等、利用者が当サイトに直接送信した情報を取得する場合があります。

第2条（取得する情報および取得方法）

当サイトは、本サービスの提供に必要な範囲で、次の情報を取得する場合があります。

1. 掲載事業者から取得する情報
会社名・事業者名、担当者氏名、電話番号、メールアドレス、所在地、求人掲載内容、お問い合わせ時の入力情報等。

2. 決済に関する情報
有料広告等の決済に際し、決済代行サービスを通じて決済状況、取引識別子等を取得する場合があります。クレジットカード番号等の決済情報は決済代行事業者が取り扱い、当サイトが管理するサーバーには保存しない運用とします。

3. 技術情報およびスパム防止情報
IPアドレス、アクセスログ、端末・ブラウザに関する情報、Cookie等。また、不正送信・スパム対策（Google reCAPTCHA等）の利用に伴い、デバイス情報やアクセス状況等の技術データを取得・検証する場合があります。

4. お問い合わせ情報
利用者が問い合わせフォーム等から送信した氏名、連絡先、本文その他の情報。

第3条（利用目的）

当サイトは、取得した情報を次の目的で利用します。
1. 求人情報の受付、審査、掲載、更新および運営
2. 有料広告等の決済処理、決済状況の確認および関連する連絡
3. お問い合わせ対応、本人確認および利用規約等に基づく通知
4. 規約違反、不適切な求人、詐欺等の不正利用、スパム・不正アクセスの防止・検知・対応
5. システム障害対応、セキュリティ維持およびサービスの安定運用
6. 法令に基づく対応

第4条（保存期間および削除）

1. 当サイトは、利用目的の達成に必要な期間、または法令上・運営上必要な期間に限り情報を保存し、保存の必要性がなくなった情報は、合理的な期間内に削除または個人を識別できない形に加工するよう努めます。

2. 求人掲載終了後の求人情報および関連事業者情報は、法令上の保管義務、問い合わせ・紛争への対応、不正利用防止、セキュリティ確保その他正当な必要性がある場合を除き、必要性がなくなった後、合理的な期間内に削除または匿名化等の処理を行います。

3. アクセスログ等の技術情報は、セキュリティ確保、障害対応、防犯または法令対応に必要な範囲・期間で保存し、その後、順次削除等を行います。具体的な保存期間は、利用するシステムやログの種類により異なる場合があります。

第5条（第三者提供および業務委託）

1. 当サイトは、法令に基づく場合、人の生命・身体・財産の保護に必要で本人の同意を得ることが困難な場合その他個人情報保護法等により認められる場合を除き、本人の同意なく個人データを第三者に提供しません。

2. 当サイトは、サーバー・データベース運用、決済、セキュリティ、問い合わせ対応等の業務を外部事業者に委託する場合があります。その場合、委託先を適切に選定し、法令に従い必要かつ適切な監督を行います。

第6条（外国にある事業者のサービス利用）

1. 当サイトは、本サービスの運営にあたり、Google（Firebase, reCAPTCHA等）、Stripe、Anthropic等の外部サービスを利用する場合があります。これらのサービスでは、利用する機能・設定に応じて、情報が日本国外の設備で保存または処理される場合があります。各事業者の所在地、適用される制度、提供先および保護措置については、実際の利用サービス・契約・設定に応じて確認し、法令上必要な情報提供や同意取得等を行います。

2. 外国にある第三者への個人データの提供に該当する場合、当サイトは、個人情報保護法その他関係法令に従い、必要な情報提供、同意取得その他の対応を行います。サービスの利用のみをもって、あらゆる外国第三者提供への包括的な同意が成立するものとは扱いません。

第7条（Cookie等の利用）

当サイトは、セッション管理、セキュリティ確保、利便性向上等のため、Cookieその他これに類する技術を使用する場合があります。ブラウザの設定によりCookieを無効化できる場合がありますが、その場合、本サービスの一部機能が利用できなくなることがあります。アクセス解析等の外部ツールを導入する場合は、実際の利用状況に応じて、その名称・目的等を本ポリシー等で案内します。

第8条（安全管理措置）

当サイトは、取り扱う情報の漏えい、滅失または毀損の防止その他の安全管理のため、アクセス制御、通信の暗号化、不正アクセス対策等、情報の性質や利用状況に応じた必要かつ適切な措置を講じます。具体的な措置の詳細は、セキュリティ上の理由により開示できない場合があります。

第9条（利用者による情報提供）

利用者が当サイトに情報を送信する場合、送信内容に第三者の個人情報等を含めるときは、必要な権限・同意等を得たうえで、必要最小限の情報を送信してください。応募・採用に関する情報は、原則として掲載事業者へ直接提供してください。

第10条（本ポリシーの変更）

当サイトは、法令改正やサービス内容・運営方法の変更等に応じて、本ポリシーを改定することがあります。重要な変更を行う場合は、変更内容および適用時期を当サイト上への掲示その他適切な方法で周知します。

第11条（お問い合わせ窓口）

本ポリシーおよび個人情報の取扱いに関するお問い合わせは、当サイト内のお問い合わせフォームより受け付けます。`
...
.kk-terms-section { background: #fff; border-radius: 8px; padding: 16px; }
.kk-terms-body { font-size: 12.5px; line-height: 1.9; color: #333; white-space: pre-wrap; margin: 14px 0; }
...
.kk-about-subtitle { font-size: 14px; font-weight: 700; color: #1a237e; margin: 18px 0 6px; }
.kk-about-example { background: #f5f6fa; border-left: 3px solid #1a237e; border-radius: 4px; padding: 10px 14px; font-size: 12.5px; line-height: 1.9; color: #444; margin: 10px 0 14px; }
...
export default function App() {
  ...
  // 利用規約・プライバシーポリシーページを開く（フッターや同意チェックボックスのリンクから）
  const [termsReturnView, setTermsReturnView] = useState('home')
  const openTerms = () => {
    setTermsReturnView(view)
    setView('terms')
    window.scrollTo(0, 0)
  }
  const closeTerms = () => {
    setView(termsReturnView)
  }
  const openPrivacy = () => {
    setTermsReturnView(view)
    setView('privacy')
      ...
      <div className="kk-app">
        ...
        <section id="about" className="kk-about-section">
          ...
          <div className="kk-about-box">
            ...
            <div className="kk-about-subtitle">有料プランのお支払いについて</div>
            <p className="kk-detail-text">
              初回のお支払いは、お申し込み手続き完了時にその場で決済されます。2回目以降のお支払いは、お申し込み日にかかわらず<strong>毎月25日に自動更新（自動課金）</strong>されます。
            </p>
            <div className="kk-about-example">
              例：9月10日にお申し込みいただいた場合<br/>
              → 9月10日：初回のお支払い（お申し込み時に即時決済）<br/>
              → 9月25日：2回目のお支払い（自動更新）<br/>
              → 10月25日：3回目のお支払い（以降、毎月25日に自動更新）
            </div>
            <p className="kk-detail-text">
              解約をご希望の場合は、次回のお支払い日（毎月25日）の1か月前までにお問い合わせフォームよりご連絡ください。日割りでの減額・返金は行っておりません。詳しくは<a href="#" onClick={e=>{e.preventDefault(); openTerms()}}>利用規約</a>をご確認ください。
            </p>
            ...
            {postStatus === 'success' ? (
              ...
              <form className="kk-postform" onSubmit={handlePostSubmit}>
                ...
                <label className="kk-form-agree">
                  ...
                  <span><a href="#" onClick={e=>{e.stopPropagation(); e.preventDefault(); openTerms()}}>利用規約</a>および<a href="#" onClick={e=>{e.stopPropagation(); e.preventDefault(); openPrivacy()}}>プライバシーポリシー</a>に同意します（必須）</span>
                </label>
        ...
        {/* 利用規約ページ */}
        {view === 'terms' && (
          <section id="terms" className="kk-terms-section">
            <button className="kk-back-btn" onClick={closeTerms}>← 戻る</button>
            <div className="kk-terms-body">{TERMS_TEXT}</div>
            <button className="kk-back-btn" onClick={closeTerms}>← 戻る</button>
          </section>
        )}
        ...
        {/* プライバシーポリシーページ */}
        {view === 'privacy' && (
          <section id="privacy" className="kk-terms-section">
            <button className="kk-back-btn" onClick={closePrivacy}>← 戻る</button>
            <div className="kk-terms-body">{PRIVACY_TEXT}</div>
            <button className="kk-back-btn" onClick={closePrivacy}>← 戻る</button>
          </section>
        )}
        ...
        <footer className="kk-footer">
          <div className="kk-footer-links">
            ...
            <a href="#" onClick={e=>{e.preventDefault(); openTerms()}}>利用規約</a>
            <a href="#" onClick={e=>{e.preventDefault(); openPrivacy()}}>プライバシーポリシー</a>
          </div>
