        ...
        {(() => {
          ...
          return (
            <div className="kk-premium-ad" onClick={()=>openJobDetail(premiumJob)}>
              ...
              <div className="kk-premium-company">{premiumJob.jobTitle || premiumJob.companyName}</div>
              <div className="kk-premium-desc">{premiumJob.companyAddress}{premiumJob.payRate ? '　'+premiumJob.payRate : ''}　▶ 詳しく見る</div>
            </div>
          )
        })()}
