...
const ADMIN_PASSWORD = 'keikamotsu-admin-2026'
const dummyCounts = {
...
const emptyListingForm = {
  ...
  jobTitle: '', jobType: 'regular', payRate: '', workDays: '', hasRoyalty: '',
  description: '', plan: 'free', agree: false,
}
        ...
        <div className="kk-admin-wrap">
          ...
          {filteredListings.map(listing => (
            <div key={listing.id} className="kk-admin-card">
              ...
              {listing.description && <div className="kk-admin-card-desc">{listing.description}</div>}
            ...
            {postStatus === 'success' ? (
              ...
              <form className="kk-postform" onSubmit={handlePostSubmit}>
                <div className="kk-form-group">
                  <label>会社名<span className="kk-required">必須</span></label>
                ...
                <div className="kk-form-row">
                  <div className="kk-form-group">
                    <label>業務形態</label>
                    <select value={postForm.jobType} onChange={e=>updatePostForm('jobType', e.target.value)}>
                      <option value="regular">定期委託</option>
                      <option value="spot">スポット便</option>
                      <option value="both">定期・スポット両方</option>
                    </select>
                  </div>
                  <div className="kk-form-group">
                    <label>単価・給与目安</label>
                ...
                <div className="kk-form-group">
                  <label>勤務日数・曜日</label>
                  <input type="text" placeholder="例：週5日（応相談）" value={postForm.workDays} onChange={e=>updatePostForm('workDays', e.target.value)} />
                </div>
                ...
                <div className="kk-form-group">
                  <label>案件詳細・PR文</label>
                  <textarea rows={4} placeholder="仕事内容、必要な車両、歓迎する経験などご自由にご記入ください" value={postForm.description} onChange={e=>updatePostForm('description', e.target.value)} />
                </div>
