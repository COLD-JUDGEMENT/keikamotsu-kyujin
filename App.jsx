...
export default function App() {
  ...
  // 利用規約ページを開く（フッターや同意チェックボックスのリンクから）
            ...
            {postStatus === 'success' ? (
              ...
              <form className="kk-postform" onSubmit={handlePostSubmit}>
                ...
                <label className="kk-form-agree">
                  ...
                  <span><a href="#" onClick={e=>{e.stopPropagation(); e.preventDefault(); openTerms()}}>利用規約</a>および<a href="#" onClick={e=>{e.stopPropagation(); e.preventDefault()}}>プライバシーポリシー</a>に同意します（必須）</span>
                </label>
