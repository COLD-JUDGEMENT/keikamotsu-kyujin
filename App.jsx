        ...
        {view === 'jobDetail' && selectedJob && (
          <section id="jobDetail" className="kk-jobdetail-section">
            ...
            {(selectedJob.vehicleCondition || selectedJob.vehicleConditionDetail) && (
              <div className="kk-detail-row"><span className="kk-detail-label">車両条件</span><span>{selectedJob.vehicleCondition}{selectedJob.vehicleConditionDetail ? '　'+selectedJob.vehicleConditionDetail : ''}</span></div>
            )}
