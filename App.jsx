...
.kk-premium-ad { background: linear-gradient(135deg, #fff8e1, #ffecb3); border: 2px solid #f9a825; border-radius: 10px; text-align: center; padding: 14px 16px; margin: 10px 16px; cursor: pointer; box-shadow: 0 2px 10px rgba(249,168,37,0.25); transition: transform 0.12s; }
...
.kk-premium-jobtitle { font-size: 14px; color: #555; font-weight: 600; margin-bottom: 6px; }
.kk-premium-highlights { display: flex; gap: 8px; justify-content: center; flex-wrap: wrap; margin-bottom: 4px; }
