...
.kk-chip { display: inline-flex; align-items: center; gap: 4px; font-size: 12px; border: 1px solid #ccc; border-radius: 16px; padding: 5px 12px 5px 8px; cursor: pointer; background: #fff; white-space: nowrap; transition: background 0.1s, border-color 0.1s; }
